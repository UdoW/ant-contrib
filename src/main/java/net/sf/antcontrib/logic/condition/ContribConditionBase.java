...
/**
 * Replaces {@link ConditionBase} to add more conditions and use own implementations of some
 * conditions.
 *
 * @author <a href="mailto:msi@top-logic.com">msi</a>
 */
public class ContribConditionBase extends ProjectComponent {
	/**
	 ...
	 * Simple constructor.
	 */
	protected ContribConditionBase() {
		taskName = "component";
	}
	 ...
	 */
	protected ContribConditionBase(String taskName) {
	 ...
	 *
	 * @param name
	 *        The name to use in logging messages. Should not be <code>null</code>.
	 * @since Ant 1.7
	 */
    ...
    /**
     * Add an &lt;isempty&gt; condition.
     *
     * @param i an IsEmpty condition
     * @since Ant 1.5
     */
    public void addIsEmpty(IsEmpty i) {
        conditions.add(i);
    }
}
